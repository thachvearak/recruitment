!function($, wysi) {
    ...
    var tpl = {
        ...
        "link": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade insert-link-window'>" +
                ...
                "<div class='modal-footer'>" +
                  "<a href='#' class='btn btn-cancel' data-dismiss='modal'>" + locale.link.cancel + "</a>" +
        ...
        "image": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade insert-image-window'>" +
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'>&times;</a>" +
                ...
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href='#' class='btn btn-cancel' data-dismiss='modal'>" + locale.image.cancel + "</a>" +
        ...
        "color": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              ...
              "<ul class='dropdown-menu'>" +
                ...
                "<li><div class='wysihtml5-colors' data-wysihtml5-command-value='cornflowerblue'></div><a class='wysihtml5-colors-title' data-wysihtml5-command='foreColor' data-wysihtml5-command-value='cornflowerblue'>" + locale.colours.cornflowerblue + "</a></li>" +
                "<li><div class='wysihtml5-colors' data-wysihtml5-command-value='orange'></div><a class='wysihtml5-colors-title' data-wysihtml5-command='foreColor' data-wysihtml5-command-value='orange'>" + locale.colours.orange + "</a></li>" +
                "<li><div class='wysihtml5-colors' data-wysihtml5-command-value='brown'></div><a class='wysihtml5-colors-title' data-wysihtml5-command='foreColor' data-wysihtml5-command-value='brown'>" + locale.colours.brown + "</a></li>" +
              "</ul>" +
            "</li>";
        },
        ...
        "video": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
              "<div class='bootstrap-wysihtml5-insert-video-modal modal hide fade insert-video-window'>" +
                "<div class='modal-header'>" +
                  "<a class='close' data-dismiss='modal'>&times;</a>" +
                  "<h3>" + locale.video.insert + "</h3>" +
                "</div>" +
                "<div class='modal-body'>" +
                  "<input value='http://' class='bootstrap-wysihtml5-insert-video-url input-xlarge'>" +
                "</div>" +
                "<div class='modal-footer'>" +
                  "<a href='#' class='btn btn-cancel' data-dismiss='modal'>" + locale.video.cancel + "</a>" +
                  "<a href='#' class='btn btn-primary' data-dismiss='modal'>" + locale.video.insert + "</a>" +
                "</div>" +
              "</div>" +
              "<a class='btn" + size + "' data-wysihtml5-command='insertVideo' title='" + locale.video.insert + "' tabindex='-1'><i class='icon-video'></i></a>" +
            "</li>";
        }
    };
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["/assets/css/wysihtml5/wysiwyg-color.css"], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
